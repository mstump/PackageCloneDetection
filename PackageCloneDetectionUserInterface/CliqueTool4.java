...
public class CliqueTool4 extends Tool
{
        JTabbedPane m_Tab;
	...
	public void GenerateLibraries(String cliqueName)
	{
	...
	System.out.format("checking for %s\n", cliqueName);
	                FileReader readFile = null;
               	        ...
               	        readFile = new FileReader("CommonLibraries.xml");
               	        reader = new BufferedReader(readFile);

			m_ProgramGraphBuilder.ParseLibrariesResults(reader, cliqueName);
		} catch (Exception e) {
			System.out.format("exception %s", e.getMessage());
		}
	}

	public CliqueTool4(ApplicationFrame applicationFrame, String distro)
	{
...
//		m_Layout = new mxOrganicLayout(m_Graph);
		...
		m_Frame = new JInternalFrame("Bipartite Graph of Common Libraries Belonging to Packages", true, true);
