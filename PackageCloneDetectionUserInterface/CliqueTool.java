...
public class CliqueTool extends Tool
{
        JTabbedPane m_Tab;
	...
	public void GenerateSpanningTree(String cliqueName)
	{
	...
	System.out.format("checking for %s\n", cliqueName);
	                FileReader readFile = null;
               	        ...
               	        readFile = new FileReader("PackageSpanningTrees.xml");
               	        reader = new BufferedReader(readFile);

			m_ProgramGraphBuilder.ParseSpanningTreeResults(reader, cliqueName);

/*
                        readFile = new FileReader("Clique.xml");
                        reader = new BufferedReader(readFile);
...
*/
	...
	public CliqueTool(ApplicationFrame applicationFrame, String distro)
	{
...
//		m_Layout = new mxStackLayout(m_Graph);
		...
		m_Frame = new JInternalFrame("Spanning Tree", true, true);
