...
public class CliqueTool2 extends Tool
{
        JTabbedPane m_Tab;
	...
	public void GenerateClique(String cliqueName)
	{
	...
	System.out.format("checking for %s\n", cliqueName);
			...
			m_ProgramGraphBuilder.ParseCliqueResults(reader, cliqueName);
		} catch (Exception e) {
			System.out.format("exception %s", e.getMessage());
		}
	}

	public CliqueTool2(ApplicationFrame applicationFrame, String distro)
	{
...
//		m_Layout = new mxStackLayout(m_Graph);
		...
		m_Frame = new JInternalFrame("Graph of Clique", true, true);
